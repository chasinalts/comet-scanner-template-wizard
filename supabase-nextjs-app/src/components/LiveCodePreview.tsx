        ...
        {!isMinimized && (
          <>
            ...
            <div
              ...
              data-oid="w.272ol"
            >
              <div className="grid grid-cols-2 gap-2" data-oid="2mtkvhs">
                <button
            ...
            {/* Code Statistics */}
            <div className="p-4 border-t border-cyan-500/30" data-oid="74371tl">
              <div
                className="text-xs text-gray-400 space-y-1"
                data-oid="9x2uts7"
              >
                <div data-oid=":g_fe6k">Lines: {code.split("\n").length}</div>
                <div data-oid="y-uyp59">Characters: {code.length}</div>
                <div data-oid="byxp1wl">
                  Status:{" "}
            ...
            {savedTemplates.length > 0 && (
              ...
              >
                ...
                <div className="space-y-1" data-oid="t5qjjam">
