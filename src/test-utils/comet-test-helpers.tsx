...
export const createCOMETTestContext = (
  overrides: Partial<COMETTestContext> = {},
): COMETTestContext => ({
  templates: [
    {
      id: "template-1",
...
export const createMockAIResponse = (overrides: any = {}) => ({
  ...
  explanation:
    "This is an AI-generated Pine Script scanner that detects momentum patterns.",
  ...overrides,
});
...
export const simulateWizardFlow = async (
...
export const simulateAdminLogin = async (
  user: ReturnType<typeof userEvent.setup>,
...
export const customMatchers = {
  ...
  toBeAccessible: (received: HTMLElement) => {
    ...
    return {
      message: () =>
        `Expected element to be accessible (score: ${accessibility.score})`,
