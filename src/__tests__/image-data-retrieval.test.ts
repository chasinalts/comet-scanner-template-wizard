      ...
      if (collection === 'images') {
        ...
        if (filterType === 'banner') {
          return Promise.resolve([
            { id: 'banner-1', file_path: 'banner/image1.jpg', image_type: 'banner' },
          ]);
        } else if (filterType === 'gallery') {
          return Promise.resolve([
            { id: 'gallery-1', file_path: 'gallery/image1.jpg', image_type: 'gallery' },
            { id: 'gallery-2', file_path: 'gallery/image2.jpg', image_type: 'gallery' },
          ]);
        } else if (filterType === 'scanner') {
          return Promise.resolve([
            { id: 'scanner-1', file_path: 'scanner/image1.jpg', image_type: 'scanner' },
            { id: 'scanner-2', file_path: 'scanner/image2.jpg', image_type: 'scanner' },
          ]);
        }
      }
      return Promise.resolve([]);
