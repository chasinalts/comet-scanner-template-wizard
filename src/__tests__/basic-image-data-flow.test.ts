...
describe('Basic Image and Data Flow', () => {
  ...
  describe('Content Retrieval and Rendering', () => {
    it('should fetch and process COMET description for display', async () => {
      ...
      expect(renderedContent).toHaveProperty('content', 'Test COMET description');
      expect(renderedContent).toHaveProperty('displayContent', 'Test COMET description');
    });
  ...
  describe('End-to-End Flow', () => {
    it('should simulate the full flow from storage to UI', async () => {
      ...
      expect(processedContent).toHaveProperty('displayContent', 'Test COMET description');
    });
  });
});
