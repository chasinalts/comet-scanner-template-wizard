 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lw(n,e,t){let r=1,i=null,s=null,a=!1,c=0;function l(){return c===2}let d=!1;function p(...k){d||(d=!0,e.apply(null,k))}function g(k){i=setTimeout(()=>{i=null,n(b,l())},k)}function w(){s&&clearTimeout(s)}function b(k,...q){if(d){w();return}if(k){w(),p.call(null,k,...q);return}if(l()||a){w(),p.call(null,k,...q);return}r<64&&(r*=2);let B;c===1?(c=2,B=0):B=(r+Math.random())*1e3,g(B)}let N=!1;function V(k){N||(N=!0,w(),!d&&(i!==null?(k||(c=2),clearTimeout(i),g(0)):k||(c=1)))}return g(0),s=setTimeout(()=>{a=!0,V(!0)},t),V}function hw(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
