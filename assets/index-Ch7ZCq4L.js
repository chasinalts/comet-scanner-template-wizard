const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Login-B8CxpWJR.js","assets/vendor-ui-C2WKSLH5.js","assets/vendor-react-CSTjpmlB.js","assets/HolographicText-BzxdtDtY.js","assets/Signup-B7B5uyFS.js","assets/ScannerWizard-DTYpXorx.js","assets/FormField-F_7V9TEd.js","assets/AdminDashboard-EyrDBF1l.js","assets/browser-BzhrmF_M.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nr(n,e){return Is(n,"POST","/v1/accounts:signInWithIdp",At(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gr{constructor(){this.providerId=gr.PROVIDER_ID}static credential(e,t){return ls._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Rc.parseLink(t);return j(r,"argument-error"),ls._fromEmailAndCode(e,r.code,r.tenantId)}}gr.PROVIDER_ID="password";gr.EMAIL_PASSWORD_SIGN_IN_METHOD="password";gr.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const En=new ws("@firebase/firestore");function Wn(){return En.logLevel}function x(n,...e){if(En.logLevel<=K.DEBUG){const t=e.map(kc);En.debug(`Firestore (${mr}): ${n}`,...t)}}function Et(n,...e){if(En.logLevel<=K.ERROR){const t=e.map(kc);En.error(`Firestore (${mr}): ${n}`,...t)}}function ar(n,...e){if(En.logLevel<=K.WARN){const t=e.map(kc);En.warn(`Firestore (${mr}): ${n}`,...t)}}function kc(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _r(n){if(n.code!==C.FAILED_PRECONDITION||n.message!==yE)throw n;x("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
